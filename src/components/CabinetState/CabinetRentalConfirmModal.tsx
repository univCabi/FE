...
// import CabinetRentalComplete from "./CabinetRentalComplete";
...
//     try {
//       const response = await rentApi(selectedCabinet); // API 호출
//       if (response?.success) {
//         console.log("대여 성공:", response);
//         // confirmRental(); // 대여 성공 후 처리
//         setIsRented(true);
//         setRentedCabinetId(selectedCabinet);
//         closeRentalModal(); // 모달 닫기
//       } else {
//         console.error("대여 실패:", response?.message);
//         closeRentalModal(); // 모달 닫기
//       }
//     } catch (error) {
...
//   if (isRented && rentedCabinetId === selectedCabinet) {
//     return (
